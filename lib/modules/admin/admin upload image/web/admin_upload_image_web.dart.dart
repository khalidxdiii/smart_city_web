...
import '../admin_upload_image.dart';
import 'cubit web/cubit.dart';
import 'cubit web/states.dart';

class AdminCameraScreenWeb extends StatelessWidget {
  const AdminCameraScreenWeb(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        ...
        child:
            BlocConsumer<AdminUploadReportwebCubit, AdminUploadReportwebStates>(
